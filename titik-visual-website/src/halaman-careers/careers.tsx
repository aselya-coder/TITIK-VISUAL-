        ...
        <section className="hero">
          <div className="container">
            ...
            <div className="hero-buttons">
              ...
              <a href="../halaman-lowongan-kerja/lowongan-kerja.tsx" className="btn btn-secondary">
            ...
            <div className="about-grid">
              ...
              <div className="about-image">
                <div className="image-card">
                  <img src="../img/image.png" alt="Logo Titik Visual" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="program-grid">
              <div className="program-item">
                ...
                <div className="program-content">
                  ...
                  <p>Program yang dimana perusahaan menunjuk langsung praktisi mentor untuk memberikan pengajaran ke siswa/mahasiswa.</p>
                </div>
              </div>
              <div className="program-item">
        ...
        <section className="contact-section">
          <div className="container">
            ...
            <div className="contact-grid">
              ...
              <div className="contact-card">
                <div className="contact-icon">
                  <i className="fix all issues:11y/anchor-is-valid" aria-label="Email titikvisualjogja@gmail.com"></i>
                </div>
                <h4>Email</h4>
              ...
              <ul>
                ...
                <li><button 
                  onClick={() => window.location.href = '#careers'} 
                          className="footer-link-button active"
                          aria-label="Careers"
                  >
                    Careers
                  </button></li>
