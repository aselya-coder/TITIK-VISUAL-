        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="text-left max-w-xl flex flex-col justify-center">
            ...
            <h1 className="text-5xl md:text-6xl font-extrabold leading-tight">
              <span className="bg-gradient-to-r from-[#9333EA] to-[#0891B2] bg-clip-text text-transparent">UI/UX Design</span>
              <br />
              <span className="text-[#111827]">yang User-Centered</span>
            </h1>
            <p className="text-[#6B7280] mb-8 max-w-xl">
              Ciptakan pengalaman digital yang luar biasa dengan desain interface yang intuitif, menarik, dan berfokus pada kebutuhan pengguna. Dari riset hingga prototype, kami pastikan setiap elemen mendukung tujuan bisnis Anda.
            </p>
